# From https://github.com/Sarcasm/irony-mode/blob/master/server/cmake/modules/FindLibClang.cmake
...
if (NOT EXISTS ${LIBCLANG_INCLUDE_PATH})
set(libclang_llvm_header_search_paths
  $ENV{LIBCLANG_INCLUDE_PATH}
  )
else()
set(libclang_llvm_header_search_paths
...
if (NOT EXISTS ${LIBCLANG_LIBRARY_PATH})
set(libclang_llvm_lib_search_paths
  # LLVM Fedora
  /usr/lib/llvm
  $ENV{LIBCLANG_LIBRARY_PATH}
  )
else()
set(libclang_llvm_lib_search_paths
  # LLVM Fedora
